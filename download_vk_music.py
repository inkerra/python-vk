...
def options():
    ...
    parser.add_argument('-p', '--passwd', metavar='PASSWD', help='password')
    ...
    parser.add_argument('-n', '--dirname', metavar='DIRNAME',
                        default='download',
                        help='storage directory name in DIRPATH')
    parser.add_argument('--links_dirname', metavar='DIRNAME',
                        default='playlist',
